...
class FineTuningStrategy(InitParaRecorder):
    ...
    Args:
        checks_actions_paras (Sequence[Tuple[Callable, Callable, dict]], optional): 
    ...
    def __init__(self,
                 checks_actions_paras: Sequence[Tuple[Callable, Callable, dict]] = [],
        ...
        for cap in self.caps:
            ...
            if check_func(parent_module, current_name, global_name, class_name, current_module):
                if isinstance(act_func, FineTuningStrategy):
                    ...
                    return act_func(parent_module, current_name, global_name, class_name, current_module)
                else:
